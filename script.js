...
const CONFIG = {
  ...
  // گزینه‌های مرحله 1
  step1Options: [
    "😂 اشکالی نداره، بیا بگیر",
    "🏃 اول بیا مدرسه بعد صحبت کنیم",
    "😐 این دفعه دیگه فراموش نکن",
  ],

  // گزینه‌های مرحله 2
  step2Options: [
    "📝 بررسی می‌کنم و می‌گم",
    "😂 خودت باید بدونی!",
    "🤔 بعداً بهت می‌گم",
  ],
  ...
  step3Options: [
    "❤️ باشه، بررسی می‌کنم",
    "🤔 باید ببینم چه کار کردی",
    "😂 اول برو دفترچه‌تو بگیر",
  ],
};
...
function sendWhatsAppMessage() {
  ...
  const rawMessage = `سلام آقای مدیر 😄
🎯 گزارش مأموریت ویژه
...
و قول می‌دم این بار برای گرفتن دفترچه کارورزی یادم نره 😂`;
